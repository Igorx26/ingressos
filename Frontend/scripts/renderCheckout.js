...
async function renderCheckout() {
  ...
  eventoInfo.innerHTML = `
    ...
    <p class="eventoData">Data do evento: ${new Date(evento.dataInicio).toLocaleDateString()}</p>
    <p class="eventoLocal">Local: ${evento.localizacao}</p>
    <p class="eventoPreco">Preço: R$ ${Number(lote.precoBase).toLocaleString("pt-BR", {
      style: "currency",
      currency: "BRL",
    })}</p>
  `;
